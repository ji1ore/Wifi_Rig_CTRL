...
⑥ Android版について（Wifi_RIG_CTRL_ForAndroid v1.40）
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
M5CoreS3SE の代わりに Android スマートフォンでリグをリモート制御できる
アプリを v1.30 より公開しています（最新版：v1.40）。
...
・IC-705 TX音声レベル修正（PCM 100%設定 → create_api.sh の再実行が必要）
・FM-CW時のSPK音声競合修正
...
https://github.com/ji1ore/M5CoreHamCAT/tree/main/v1.40/M5CoreHamCAT_Android
  ...
  1. Wifi_RIG_CTRL_v1.40.apk をダウンロード
...
v1.40 へのアップグレード時は create_api.sh を再実行してください（IC-705 音声修正含む）:
  bash ~/create_api.sh
