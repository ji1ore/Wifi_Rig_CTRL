...
class AppPrefs(context: Context) {
    ...
    private fun createDefaultProfile(): ProfileConfig = ProfileConfig(
        ...
        apiPort = p.getInt("apiPort", 8210),
        audioPort = p.getInt("audioPort", 8211),
    ...
    var apiPort: Int get() = p.getInt("apiPort", 8210); set(v) = p.edit().putInt("apiPort", v).apply()
    var audioPort: Int get() = p.getInt("audioPort", 8211); set(v) = p.edit().putInt("audioPort", v).apply()
    ...
    var pttPort: Int get() = p.getInt("pttPort", 5198); set(v) = p.edit().putInt("pttPort", v).apply()
