RaspberryPiのセットアップについて（Wifi_Rig_CTRL v1.31）
...
※ APRSビーコン送信中は fastapi-audio が自動停止され、
  USBオーディオが direwolf に占有されます。
...
--- ネットワーク設定 ---
wget https://raw.githubusercontent.com/ji1ore/M5CoreHamCAT/main/v1.31/RaspberryPiSetup/setup_netwk.sh
...
--- 環境構築 + api.py 生成 ---
wget https://raw.githubusercontent.com/ji1ore/M5CoreHamCAT/main/v1.31/RaspberryPiSetup/setup_fastapi_radio.sh
wget https://raw.githubusercontent.com/ji1ore/M5CoreHamCAT/main/v1.31/RaspberryPiSetup/create_api.sh
wget https://raw.githubusercontent.com/ji1ore/M5CoreHamCAT/main/v1.31/RaspberryPiSetup/set_api_key.sh
...
スクリプトが .env の更新・サービス再起動まで自動で行います。

アプリ側は Connect 画面の「API Key」欄に同じ値を入力してください。
キーが一致しない場合は接続が拒否されます（403 Forbidden）。
