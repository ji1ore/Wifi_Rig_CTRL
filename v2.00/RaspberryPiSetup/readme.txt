RaspberryPiのセットアップについて（Wifi_Rig_CTRL v2.00）

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
v2.00 での変更点
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
・FT8 / FT4 受信デコード対応（実験的機能）
  Pi 側の ft8wav デコーダを使用。create_api.sh が自動ビルドを試みます。
  ※ FT8 デコードは実験的機能です。すべての信号がデコードされるとは限りません。

・ffmpeg 録音レベルの最適化
  強信号でのクリッピングを防ぐため、キャプチャレベルを調整済み。
...
⑨FT8 / FT4 デコード（実験的機能）
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
create_api.sh の実行時に ft8wav デコーダのビルドを自動で試みます。
Rust 環境のインストールと ft8wav のクローン・ビルドに数分かかります。

ビルド後の確認:
  ~/ft8wav/ft8wav --help

ft8wav が見つからない場合は手動でビルドしてください:
  curl --proto '=https' --tlsv1.2 -sSf https://sh.rustup.rs | sh
  source ~/.cargo/env
  git clone https://github.com/ayoungblood/ft8wav.git
  cd ft8wav && cargo build --release
