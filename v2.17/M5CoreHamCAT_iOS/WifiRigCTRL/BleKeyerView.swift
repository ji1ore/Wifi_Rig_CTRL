...
struct BleKeyerView: View {
    ...
    @State private var cwPortText: String = ""
    ...
    var body: some View {
        Form {
            ...
            Section(header: Label("Pi UDP Tunnel", systemImage: "wifi")
                ...
                LabeledContent("Pi USB Port") {
                    TextField("ttyACM0", text: $cwPortText)
                        .multilineTextAlignment(.trailing)
                        .keyboardType(.asciiCapable)
                        .autocapitalization(.none)
                        .disableAutocorrection(true)
                        .onChange(of: cwPortText) { _, new in vm.cwPort = new }
                }
        ...
        .onAppear {
            if cwPortText.isEmpty { cwPortText = vm.cwPort }
        }
    }
