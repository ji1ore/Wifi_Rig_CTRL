...
struct CwView: View {
    ...
    private var contactSection: some View {
        VStack(spacing: 4) {
            ...
            HStack(spacing: 4) {
                ...
                TextField("JA2ABC", text: $vm.cwDxCall)
            ...
            HStack(spacing: 4) {
                ...
                TextField("599", text: $vm.cwRst)
                    ...
                    .foregroundStyle(.white)
                    .frame(width: 52)
                Button("×") { vm.cwRst = "" }.buttonStyle(CwCompactButtonStyle(color: Color(white: 0.27)))
                Button("5NN") { vm.cwRst = "5NN" }.buttonStyle(CwCompactButtonStyle(color: Color(white: 0.2)))
            ...
            HStack(spacing: 4) {
                ...
                TextField("JP-XXXX", text: $vm.cwPota)
                    .font(.system(.body, design: .monospaced))
                    .textInputAutocapitalization(.characters)
                    .disableAutocorrection(true)
                    .padding(.horizontal, 6).padding(.vertical, 4)
                    ...
                    .foregroundStyle(.white)
                    .frame(maxWidth: .infinity)
                Button("×") { vm.cwPota = "" }.buttonStyle(CwCompactButtonStyle(color: Color(white: 0.27)))

                Text("JCC:").font(.caption).foregroundStyle(.secondary)
                TextField("1234", text: $vm.cwJcc)
                    .font(.system(.body, design: .monospaced))
                    ...
                    .foregroundStyle(.white)
                    .frame(width: 64)
                Button("×") { vm.cwJcc = "" }.buttonStyle(CwCompactButtonStyle(color: Color(white: 0.27)))
            }
        }
        .padding(6)
    ...
    private var freeTextRow: some View {
        HStack(spacing: 6) {
            TextField("Free text", text: $vm.cwLastText)
                .font(.system(.body, design: .monospaced))
                .textInputAutocapitalization(.characters)
                .disableAutocorrection(true)
                ...
                .foregroundStyle(.white)
            Button("SEND") { Task { await vm.cwSendText(vm.cwLastText) } }
                .font(.callout.bold())
