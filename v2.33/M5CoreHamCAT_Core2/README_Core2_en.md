# Wifi_RIG_CTRL for M5Stack Core2  Ver 2.33
...
| `M5CoreHamCAT_Core2_v2.33.bin` | Pre-built firmware (merged, flashable directly at address 0x0) |

To use the pre-built `.bin` directly, flash it at address 0x0 with esptool or similar.

```bash
esptool.py --chip esp32 write_flash 0x0 M5CoreHamCAT_Core2_v2.33.bin
```
