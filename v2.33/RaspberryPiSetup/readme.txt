Wifi RIG CTRL  Raspberry Pi セットアップガイド（v2.33）

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
配布ファイル
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Wifi_RIG_CTRL_v2.30.apk  : Android アプリ
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
v2.33 での変更点（Pi 側 / スクリプト）
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
・create_api.sh: webft8 ファイルダウンロードリストに wav-save.js を追加
    jl1nie/webft8 のアップデート後に不足していたファイル。
    これがないと webft8 の「Loading WASM で止まる」問題が発生する。
    「Update WebFT8」ボタンで自動適用される。

・server_webft8.py: 起動時に GitHub から最新 JS ファイルを自動更新
    webft8 サービス起動のたびに jl1nie/webft8 から最新の JS ファイルを取得するよう変更。
    SW.ready タイムアウトパッチ・sw.js skipWaiting パッチを適用。

・API_VERSION を 2.33 に更新

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
v2.31 / v2.32 での変更点（Pi 側）
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
・Pi 側スクリプト変更なし（v2.30 と同一）
    v2.31 / v2.32 の変更はアプリ（Android / iOS）側のみ。
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
--- ネットワーク設定（任意）---
wget https://raw.githubusercontent.com/ji1ore/M5CoreHamCAT/main/v2.30/RaspberryPiSetup/setup_netwk.sh
chmod +x setup_netwk.sh
bash setup_netwk.sh

--- 環境構築（FT8 含む全機能セットアップ・UpdatePi 相当）---
BASE=https://raw.githubusercontent.com/ji1ore/M5CoreHamCAT/main/v2.30/RaspberryPiSetup
...
FT8/FT4 送信（webft8 UI からの TX）を使う場合:
  wget https://raw.githubusercontent.com/ji1ore/M5CoreHamCAT/main/v2.30/RaspberryPiSetup/setup_ft8_encode.sh
...
【GitHub から再取得】スクリプトを最新版に更新してから再セットアップ
  Pi に SSH でログイン後:
  wget -O ~/create_api.sh https://raw.githubusercontent.com/ji1ore/M5CoreHamCAT/main/v2.30/RaspberryPiSetup/create_api.sh
  wget -O ~/set_api_key.sh https://raw.githubusercontent.com/ji1ore/M5CoreHamCAT/main/v2.30/RaspberryPiSetup/set_api_key.sh
