...
int selRig = 0;
int dbgBootSavedRigId = -99999; // ★ デバッグ用: 起動直後にNVSから読んだ生のrigId値(後で出力する)
int selCat = 0;
...
int selCwDevice = 0;
bool cwBridgeOpen = false;
String cwOpenedDevice = "";
std::vector<String> audioDevList;
int selAudioDevice = 0;
